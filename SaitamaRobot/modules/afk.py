...
def afk(update: Update, context: CallbackContext):
    ...
    if len(args) >= 2:
        ...
        if len(reason) > 100:
            reason = reason[:100]
            notice = "\nAlasan kamu afk telah dipersingkat dari 100 Kata."
    else:
        reason = ""
    ...
    try:
        update.effective_message.reply_text("{} telah afk #afk{}".format(
            fname, notice))
    except BadRequest:
        pass
        ...
        for ent in entities:
            ...
            if ent.type == MessageEntity.MENTION:
                ...
                try:
                    ...
                    print("Error: Gabisa dapetin userid dari {} untuk afk."
                          .format(user_id))
                    return
